...
class Snake:
    ...
    def start_again(self):
        for segment in self.new_segments:
            segment.goto(1000, 1000)  # Mueve los segmentos fuera de la pantalla
        self.new_segments.clear()  # Limpia la lista de segmentos
        self.segments()  # Crea la serpiente nuevamente
        self.head = self.new_segments[0]  # Reasigna la cabeza
